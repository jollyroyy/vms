// CHECK for goal.md SEC-7 — Frontend route protection. Imports ROLE_ROUTES and
// isForbidden from the SAME source ProtectedRoute uses in App.tsx, so a passing
// test means the real component enforces the rule. The admin and ceo roles have
// a file each, split off at the 300-line cap.
