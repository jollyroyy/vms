...
// An arrow leaving a doorway — the gate's exit. Deliberately NOT a second tick:
// "Checked In" already owns the tick, the two tiles sit side by side, and a
// second one would say the same thing about the opposite event.
export const ICON_EXIT =
