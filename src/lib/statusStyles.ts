...
export const STATUS_STYLES: Record<VisitStatus, StatusStyle> = {
  pending_approval: { bg: 'bg-amber-50 dark:bg-amber-500/12',   text: 'text-amber-700 dark:text-amber-300',   dot: 'bg-amber-400', label: 'Pending' },
  ...
  approved:         { bg: 'bg-blue-50 dark:bg-blue-500/12',     text: 'text-blue-700 dark:text-blue-300',     dot: 'bg-blue-500',  label: 'Pre-approved' },
  walkin_approved:  { bg: 'bg-indigo-50 dark:bg-indigo-500/12', text: 'text-indigo-700 dark:text-indigo-300', dot: 'bg-indigo-500', label: 'Walk-in approved' },
  ...
  no_show:          { bg: 'bg-orange-50 dark:bg-orange-500/12', text: 'text-orange-700 dark:text-orange-300', dot: 'bg-orange-500', label: 'No Show' },
};
