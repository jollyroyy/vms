...
export default function ReportsPage(): React.ReactElement {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="print-only"><h2 className="text-xl font-bold">Daily Visitor Register — {date}</h2><p className="text-sm text-navy-400">Secure Gate — Mall Management Office</p></div>
