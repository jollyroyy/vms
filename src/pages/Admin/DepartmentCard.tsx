        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h3 className="font-semibold text-navy-900 truncate leading-tight">{d.name}</h3>
              <span className="glass-chip !px-2 !py-0.5 !text-[11px] font-mono tracking-wider text-navy-500 mt-1.5">
                {d.code}
              </span>
            </div>
          </div>
