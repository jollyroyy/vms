...
// One card in the Hosts Directory grid: the round initials face every board
// in the app already uses (`initialsOf`), the host's name, their department,
// and this week's arrival count. Four facts, none repeated — the name is not
// also printed as a heading elsewhere on the card, and the department is not
// also carried by a colour, matching the no-duplicate-renders rule the rest
// of the admin surface follows.
