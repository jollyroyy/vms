  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center p-6">
      <div className="card-premium max-w-md w-full px-8 py-12 text-center animate-scale-in">
        ...
        <p className="mt-4 text-xs font-bold uppercase tracking-[0.2em] text-navy-500 dark:text-navy-400">Secure Gate</p>
        <h1 className="mt-2 text-xl font-bold text-navy-950 font-display">Page not found</h1>
        <p className="mt-2 text-sm text-navy-500 dark:text-navy-400">The page you are looking for doesn&rsquo;t exist or has been moved.</p>
