    ...
    <Link
      ...
      <div className="flex items-center gap-3">
        <div
          ...
          style={visit.visitor?.photo_path ? undefined : { background: AVATAR_FALLBACKS[index % AVATAR_FALLBACKS.length] }}>
          {visit.visitor?.photo_path ? (
            <img src={visit.visitor.photo_path} alt={visit.visitor.full_name} className="w-full h-full object-cover" />
          ) : (
