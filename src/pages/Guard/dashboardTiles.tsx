...
const glyph = (...paths: string[]): React.ReactNode => (
...
const DOOR_IN = ['M15 3.75h2.25A2.25 2.25 0 0119.5 6v12a2.25 2.25 0 01-2.25 2.25H15', 'M12 15l3-3m0 0l-3-3m3 3H4.5'];
const DOOR_OUT = ['M15 3.75H6.75A2.25 2.25 0 004.5 6v12a2.25 2.25 0 002.25 2.25H15', 'M16.5 15l3-3m0 0l-3-3m3 3H9'];
...
const CALENDAR = 'M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5';
const CALENDAR_X = [CALENDAR, 'M10 13.75l4 4m0-4l-4 4'];
const CALENDAR_CHECK = [CALENDAR, 'M10 15.75l1.5 1.5 3-3.5'];
const SHIELD_X = [
...
const CLOCK = ['M12 6.75v5.25l3.25 2', 'M21 12a9 9 0 11-18 0 9 9 0 0118 0z'];
