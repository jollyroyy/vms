        ...
        {loading ? (
          ...
          <div className="divide-y divide-surface-100 dark:divide-white/[0.05]">
            {alerts.map((a) => {
              ...
              return (
                <div key={a.id} className="bg-danger-50 border border-danger-200 rounded-xl p-3 m-3 flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-sm font-bold text-danger-900 truncate">{a.visitor.full_name}</p>
