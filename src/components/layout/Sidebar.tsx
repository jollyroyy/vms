          ...
          {isCollapsed ? (
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                title="Sign out"
                className="shrink-0 h-8 w-8 rounded-lg flex items-center justify-center text-navy-300 hover:text-danger-500 hover:bg-danger-500/10 transition-all duration-200"
              >
