  ...
  return (
    <>
      ...
      <button type="button" onClick={() => setMobileOpen(!mobileOpen)} aria-label="Open menu"
        className="no-print lg:hidden mobile-menu-button fixed z-50 h-9 w-9 rounded-xl flex items-center justify-center text-navy-600 dark:text-navy-300 card-glass !rounded-xl active:scale-95 transition-all">
      ...
      {mobileOpen && (
        <div className="no-print lg:hidden fixed inset-0 z-40">
          ...
          <aside className="absolute left-0 top-0 bottom-0 w-72 max-w-[85vw] safe-top safe-bottom card-glass !rounded-none !border-y-0 !border-l-0 animate-slide-down overflow-hidden">
